...
# plugin.GetLoadMode) and maydependon.NewAnalyzer from the *external*
# custom-gcl framework, not from cmd/dlinter (this module's only main
# package). deadcode can only trace reachability from main packages inside
